...
namespace NetSqlAzMan.SnapIn
{
    [MMC.SnapInSettings("{C8466485-78DA-473a-B864-3FE1A9A6F781}",
        ...
        Description = "Management Console for .NET SQL Authorization Manager Ver. 3.6.0.7. The .NET Sql Authorization Manager allows you to set item-based permissions for Authorization Manager-enabled .NET applications.",
