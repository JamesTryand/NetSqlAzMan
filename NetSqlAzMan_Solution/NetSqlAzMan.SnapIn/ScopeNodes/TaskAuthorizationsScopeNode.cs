...
{
    public class TaskAuthorizationsScopeNode : ScopeNodeBase
    {
        protected IAzManApplication application;

        public TaskAuthorizationsScopeNode(IAzManApplication application)
            : base(!application.HasItems(ItemType.Task))
        {
            this.application = application;
            // Create a message view for Task node.
            MMC.MmcListViewDescription lvdStoreGroups = new MMC.MmcListViewDescription();
            lvdStoreGroups.DisplayName = Globalization.MultilanguageResource.GetString("Folder_Msg110");
        ...
        {
            //Prepare Node
            this.DisplayName = Globalization.MultilanguageResource.GetString("Folder_Msg110");
            this.SubItemDisplayNames.Clear();
            this.SubItemDisplayNames.Add(Globalization.MultilanguageResource.GetString("Folder_Tit110"));
