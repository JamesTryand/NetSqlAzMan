...
{
    public partial class dlgItemsHierarchyView : dlgPage
    {
        protected internal IAzManStorage storage = null;
        internal IAzManApplication[] applications = null;
        [PreEmptive.Attributes.Feature("NetSqlAzMan WebConsole: Items Hierarchical View")]
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (String.IsNullOrEmpty(nowaitpanel))
            {
                if (!Page.IsPostBack)
                {
                    ...
                    this.RegisterEndClientScript("window.location='dlgItemsHierarchyView.aspx?nowaitpanel=true'");
                }
            }
        ...
        internal protected TreeNode buildApplicationsTreeView()
        {
        ...
        {
            this.itemsHierarchyTreeView.CollapseAll();
        }
    }
}
