<%@ Page Language="C#" MasterPageFile="~/ModalDialog.Master" AutoEventWireup="true" CodeBehind="dlgStoreGroupProperties.aspx.cs" Inherits="NetSqlAzManWebConsole.dlgStoreGroupProperties" Title="NetSqlAzMan Web Console" StylesheetTheme="Default" ValidateRequest="false" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:TextBox ID="txtDescription" runat="server" MaxLength="1024" Height="215px" Width="90%"
        ...
        <asp:Panel ID="pnlMembers" runat="server" Width="100%" Height="270px" ScrollBars="Both">
            ...
            <br />
            <asp:GridView ID="dgMembers" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False" Width="100%">
            ...
            <asp:Button ID="btnMembersAddWindowsUsersAndGroups" runat="server" TabIndex="7" Text="Add Windows Users and Groups" OnClientClick="javascript:openDialog('ADObjectPickerShowDialog.aspx', 2);" />
            <asp:Button ID="btnMembersAddDBUsers" runat="server" TabIndex="8" Text="Add DB Users" OnClientClick="javascript:openDialog('dlgDBUsersList.aspx', 2);" />
            <asp:Button ID="btnMembersRemove" runat="server" TabIndex="9" Text="Remove" OnClick="btnMembersRemove_Click" /></asp:View>
        ...
        <asp:Panel ID="pnlNonMembers" runat="server" Width="100%" Height="270px" ScrollBars="Both">
            ...
            <br />
            <asp:GridView ID="dgNonMembers" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False" Width="100%">
                <FooterStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" />
                <RowStyle BackColor="#F7F6F3" ForeColor="#333333" />
                <EditRowStyle BackColor="#999999" />
                <SelectedRowStyle BackColor="#E2DED6" Font-Bold="True" ForeColor="#333333" />
            ...
            <br />
            <asp:Button ID="btnNonMembersAddStoreGroup" runat="server" TabIndex="10" Text="Add Store Groups" OnClientClick="javascript:openDialog('dlgStoreGroupsList.aspx', 2);" />&nbsp;<asp:Button
                ID="btnNonMembersAddWindowsUsersAndGroup" runat="server" TabIndex="11" Text="Add Windows Users and Groups" OnClientClick="javascript:openDialog('ADObjectPickerShowDialog.aspx', 2);" />&nbsp;<asp:Button
                    ID="btnNonMembersAddDBUsers" runat="server" TabIndex="12" Text="Add DB Users" OnClientClick="javascript:openDialog('dlgDBUsersList.aspx', 2);" />&nbsp;<asp:Button ID="btnNonMembersRemove" runat="server" TabIndex="13" Text="Remove" OnClick="btnNonMembersRemove_Click" /></asp:View>
    </asp:MultiView>
</asp:Content>
